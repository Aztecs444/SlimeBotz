global.teksbanned =["Kaka telah di banned","Maaf kamu sudah di banned","Yahaha udah kena banned mau akses fitur","Mboh karepmu"]

global.tekscmd =["Command tidak ditemukan","Maaf kak command tidak di temukan","Gak ada","Command tidak tersedia",
"Apaan tuh ? 🙄",
...
global.bagai = ['Kita Kenal?', 'Nanya Terus deh', 'Tidak Tahu', 'Gua tabok boleh ?', 'Cari Aja Sendiri', 'Kurang Tahu', 'Mana Saya Tahu, Saya kan ikan', 'Hah kamu tanya sama aku trus aku tanya ke siapa dong', 'Whahahaha ga tau 😑']
...
global.wa = ['Penyayang', 'Pemurah', 'Pemarah', 'Pemaaf', 'Penurut', 'Baik', 'Baperan', 'Baik Hati', 'penyabar', 'UwU', 'top deh, pokoknya', 'Suka Membantu']
...
global.teksspam =["Jangan spam om",
"Jangan spam",
"Jangan spam ya",
"Woy jangan spam",
...
global.ilhamberkata =['Lebih baik mengerti sedikit daripada salah mengerti.',
...
global.katahai =["Halo","halo","Hallo","hallo","Hai","hai","Moshi moshi","moshi moshi","Kirara","kirara"]
...
global.badud =["kirara","Kirara","bot","Bot"]
...
global.salam =["P","p","Woy","woy","Oy","oy","hey","Hey"]

global.oawalah = ['iya kak ?', 'Ada apa kak ?', 'Bot aktif kak', 'Aku bukan bot kak, aku ini hooman', 'Kumaha atuh kak ?', 'Kunaon kak ?', 'oy ?', 'ya ?', 'Kenapa panggil aku', 'Ada apa kak kok panggil aku', 'Naon siah kehed manggil manggil']
...
global.regex = ['bilek', 'banh', 'cum', 'kntl', 'anjing', 'mmk', 'bang', 'wibu', 'pantek', 'pepek', 'hentai']
...
global.thanks =["hnk","hanks","akasih","ksh","ksih"]

global.menu = ["menu","Menu","mEnu","menU","mennu","Mana menunya","help","Help"]
